...
char const *distribnamout1="_DISTRIB_OUT1_";
char const *distribnamout2="_DISTRIB_OUT2_";
char const *distribnamout3="_DISTRIB_OUT3_";
char const *distribnamout4="_DISTRIB_OUT4_";
char const *distribnamout5="_DISTRIB_OUT5_";
...
double dtimex,dtimez,dtimes,eqx,eqz,eqs,eqdelta,eqdeltas,qex1,qex2,qez1,qez2,qes1,qes2,rsq,fac,ratio_;
char path[]="RES";
char ext[]=".txt";
...
//    fflush(foutput1);
  ...
  for(KINJ=KINJ1;KINJ<NINJ+1;KINJ++)
  {
    ...
    if (KINJ==KINJ1)
    {
      ratio_=sqrt((betax[0]*exm[KINJ]+dispx[0]*dispx[0]*delta*delta)/(betaz[0]*ezm[KINJ]+dispz[0]*dispz[0]*delta*delta));
      cout << "ratio_ = " << ratio_ << endl;
    }
...
//till now everything was calculated according to this:
		  ncellx=ceil(sqrt((numpart*ratio_/(ncells*mppercell)))); 
		  ncellz=ceil(ncellx/ratio_);
//test7 is for:
		  //ncellz=ceil((numpart*ratio_/(ncells*ncellx*mppercell)));
		flag_def=1;
		flag_renorm=0;	      
